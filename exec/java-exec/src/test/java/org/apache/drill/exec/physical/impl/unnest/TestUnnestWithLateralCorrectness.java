...
public class TestUnnestWithLateralCorrectness extends SubOperatorTest {
  ...
  @BeforeClass public static void setUpBeforeClass() throws Exception {
    ...
    ljPopConfig = new LateralJoinPOP(null, null, JoinRelType.INNER, new ArrayList<>());
  ...
  private <T> void testNestedUnnest( TupleMetadata[] incomingSchemas,
    ...
    final LateralJoinPOP ljPopConfig2 = new LateralJoinPOP(projectPopConfig1, projectPopConfig2, JoinRelType.INNER, new ArrayList<>());
    final LateralJoinPOP ljPopConfig1 = new LateralJoinPOP(mockPopConfig, ljPopConfig2, JoinRelType.INNER, new ArrayList<>());

...
public class TestNullInputMiniPlan extends MiniPlanUnitTestBase{
  ...
  public void testHashJoinEmptyBoth() throws Exception {
   final PhysicalOperator join = new HashJoinPOP(null, null, Collections.singletonList(joinCond("a", "EQUALS", "b")), JoinRelType.INNER);
    testTwoInputNullBatchHandling(join);
  }

  @Test
  public void testLeftHashJoinEmptyBoth() throws Exception {
    final PhysicalOperator join = new HashJoinPOP(null, null, Collections.singletonList(joinCond("a", "EQUALS", "b")), JoinRelType.LEFT);
    testTwoInputNullBatchHandling(join);
  }

  @Test
  public void testRightHashJoinEmptyBoth() throws Exception {
    final PhysicalOperator join = new HashJoinPOP(null, null, Collections.singletonList(joinCond("a", "EQUALS", "b")), JoinRelType.RIGHT);
    testTwoInputNullBatchHandling(join);
  }

  @Test
  public void testFullHashJoinEmptyBoth() throws Exception {
    final PhysicalOperator join = new HashJoinPOP(null, null, Collections.singletonList(joinCond("a", "EQUALS", "b")), JoinRelType.FULL);
    testTwoInputNullBatchHandling(join);
  }
  ...
  public void testHashJoinLeftEmpty() throws Exception {
    ...
    RecordBatch joinBatch = new PopBuilder()
        .physicalOperator(new HashJoinPOP(null, null, Collections.singletonList(joinCond("a", "EQUALS", "a2")), JoinRelType.INNER))
        .addInput(left)
        .addInput(rightScan)
        .build();
  ...
  public void testLeftHashJoinLeftEmpty() throws Exception {
    ...
    RecordBatch joinBatch = new PopBuilder()
        .physicalOperator(new HashJoinPOP(null, null, Collections.singletonList(joinCond("a", "EQUALS", "a2")), JoinRelType.LEFT))
        .addInput(left)
        .addInput(rightScan)
        .build();

...
/**
 * Simplifies programmatic creation of {@link org.apache.calcite.sql.SqlSelect}.
 */
public class SqlSelectBuilder {
  ...
  public SqlSelect build() {
    return new SqlSelect(pos, keywordList, selectList, from, where, groupBy,
        having, windowDecls, orderBy, offset, fetch, hints);
  }

  public SqlSelectBuilder pos(SqlParserPos pos) {
    this.pos = pos;
    return this;
  }
  ...
  public SqlSelectBuilder selectList(List<SqlNode> selectList) {
    this.selectList = new SqlNodeList(selectList, SqlParserPos.ZERO);
    return this;
  }
